...
{
    public partial class VattiView : Form
    {
        ...
        private void DrawingPanel_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (_polygonVertices != null && _polygonVertices.Count > 0)
            {
                ...
                List<PointF> clippedVertices = PolygonClippers.VattiClip(
                    _polygonVertices,
            ...
            g.DrawString("Algoritmo: Vatti", new Font("Arial", 10), Brushes.Black, 10, 10);
        }
