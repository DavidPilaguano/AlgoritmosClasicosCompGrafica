...
{
    public partial class LiangBarskyView : Form
    {
        ...
        private void DrawingPanel_Paint(object sender, PaintEventArgs e)
        {
            ...
            ClippingResult result = LineClippers.LiangBarskyClip(
                _pOriginal1,
                _pOriginal2,
            ...
            g.DrawString("Algoritmo: Liang-Barsky", new Font("Arial", 10), Brushes.Black, 10, 10);
        }
