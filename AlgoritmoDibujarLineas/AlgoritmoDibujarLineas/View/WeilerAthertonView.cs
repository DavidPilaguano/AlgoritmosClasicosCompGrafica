    ...
    public partial class WeilerAthertonView : Form
    {
        ...
        private void DrawingPanel_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (_polygonVertices != null && _polygonVertices.Count > 0)
            {
                ...
                List<PointF> clippedVertices = PolygonClippers.WeilerAthertonClip(
                    _polygonVertices,
            ...
            g.DrawString("Algoritmo: Weiler-Atherton", new Font("Arial", 10), Brushes.Black, 10, 10);
        }
